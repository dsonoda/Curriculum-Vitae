...
- 基本スタンス
    ...
    - スピード重視のプロトタイピング開発以外では、自分が開発を抜けてもすぐにリカバリーができるように、命名規則・docs記法はガチガチにFixしておく。ドキュメントもなるべく残す。
...
* **実績・取り組み**: 
    ...
    - cookieに紐付けたユーザーの行動追跡データを蓄積。機械学習によるレコメンド情報の選出により、会員登録なしでアクセスユーザーにレコメンド情報を表示させる機能を実現。  
